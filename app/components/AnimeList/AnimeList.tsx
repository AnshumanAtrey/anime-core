...
const animeList = [
  {
    ...
    image: '/thumbnails/attack-on-titan-3840x2160-10339.jpg',
    episodes: 75,
    rating: 4.9,
  },
  {
    id: 2,
    title: 'Demon Slayer',
    image: '/thumbnails/demon-slayer-3840x2160-22988.jpg',
    episodes: 55,
    rating: 4.8,
  },
  {
    ...
    image: '/thumbnails/satoru-gojo-jjk-3840x2160-19527.png',
    episodes: 47,
    rating: 4.9,
  },
  {
    id: 4,
    title: 'Chainsaw Man',
    image: '/thumbnails/denji-chainsaw-man-manga-series-3840x2160-8869.jpg',
    episodes: 12,
    rating: 4.7,
  },
  {
    id: 5,
    title: 'Spy x Family',
    image: '/thumbnails/spy-x-family-loid-3840x2160-11194.png',
    episodes: 25,
    rating: 4.8,
  },
];
    ...
    <section className="py-20 bg-black relative overflow-hidden z-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {animeList.map((anime) => (
            <AnimeCard key={anime.id} anime={{...anime, thumbnail: anime.image}} />
          ))}
        </div>
